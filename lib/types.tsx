...
export interface DraftForm {
  ...
  book_attachments?: Record<string, string>;
  status: string;
  pdf_json_data?: { checklist?: string[]; driveChecklist?: string[] };
}
...
export interface SubmissionLog {
  remarks: string;
  date: string;
  action: 'RETURNED' | 'SUBMITTED' | 'VALIDATED' | 'RESUBMITTED' | 'DRAFT_CREATED' | 'DRAFT_EDITED' | 'SUBMITTED_TO_HIGHER_OFFICE' | 'PROCESSED_BY_HIGHER_OFFICE';
  actor_name: string;
}
